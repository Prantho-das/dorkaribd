            ...
            <div class="container">
                <div class="row">
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            <div class="text-center pt-4">    <h1 class="h4 fw-600">


                                {{Cookie::has('otp_verify') ? translate('Verify Otp.') : translate('Login to your account.') }}
                                </h1>
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    @if (Cookie::has('otp_verify'))
{{-- otp system --}}
<form class="form-default" role="form" action="{{ route('login-register.verify-otp') }}" method="POST">
    @csrf
    {{-- @if (addon_is_activated('otp_system') && env("DEMO_MODE") != "On") --}}
        <div class="form-group phone-form-group mb-1">
            <input type="number" class="form-control{{ $errors->has('otp') ? ' is-invalid' : '' }}" value="{{ old('otp') }}" placeholder="" name="otp" autocomplete="off">
        </div>

    <div class="mb-5">
        <button type="submit" class="btn btn-primary btn-block fw-600">{{  translate('Verify') }}</button>
    </div>
</form>

{{-- otp system --}}
                                    @else
    <form class="form-default" role="form" action="{{ route('login-register.phone') }}" method="POST">
                                        @csrf
                                        {{-- @if (addon_is_activated('otp_system') && env("DEMO_MODE") != "On") --}}
                                            <div class="form-group phone-form-group mb-1">
