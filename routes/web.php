...
Route::controller(LoginController::class)->group(function () {
    ...
    Route::post('/login-register-with-phone', 'loginRegisterByPhone')->name('login-register.phone');
    Route::post('/login-register-verify-otp', 'verifyLoginRegisterPhoneOtp')->name('login-register.verify-otp');
